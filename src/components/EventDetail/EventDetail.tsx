    ...
    return (
        <div className="relative w-full h-full min-h-screen bg-black text-white flex items-center justify-center">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="mt-10 sm:mt-8 mb-4 p-4 rounded-lg shadow-lg border border-transparent border-cyan-800">
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-between mb-4">
                                        <p className="text-white text-base sm:text-lg font-bold">Cantidad:</p>
            ...
            {isModalOpen && selectedImage && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80" ref={modalRef}>
                    <div className="relative w-full max-w-3xl max-h-[80%]">
                        <button 
                            onClick={closeModal} 
                            className="absolute top-2 right-2 p-2 bg-cyan-600 text-white rounded-full hover:bg-cyan-400 transition duration-300"
                        >
                            &times;
                        </button>
                        <Image
